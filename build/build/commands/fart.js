...
exports.fart = (message) => {
    var _a;
    exports.playFartNoise((_a = message.member) === null || _a === void 0 ? void 0 : _a.voice.channel);
};
exports.playFartNoise = (voiceChannel) => __awaiter(void 0, void 0, void 0, function* () {
    if (!voiceChannel)
        return;
